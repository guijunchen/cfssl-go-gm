...
import (
	...
	"github.com/guijunchen/cfssl-go-gm/csr"
	cferr "github.com/guijunchen/cfssl-go-gm/errors"
	"github.com/guijunchen/cfssl-go-gm/info"
...
func string1(conf *x509.CertificateRequest) string {
...
func ParseCertificateRequest(s Signer, csrBytes []byte) (template *x509.Certificate, err error) {
	...
	//fmt.Println("signer.go ParseCertificateRequest csrv:", string1(csrv))
